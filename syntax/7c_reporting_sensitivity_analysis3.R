# R file for:
# Sensitivity analysis 3: svyglm probit adjusted vcov by reported Deff
# 
# For paper:
...
# Saved name ----
sv_name <- here(out_path, "ame_sensitivity3.xlsx")
sv_name2 <- here(mdl_ame_path, "ame_main_sensitivity3.rds")
sv_name3 <- here(mdl_ame_path, "ame_fintech_sensitivity3.rds")
...
# Read models ----
mdl_account <- readRDS(here(mdl_path, "svyglm_probit_account.rds"))
mdl_saving <- readRDS(here(mdl_path, "svyglm_probit_saving.rds"))
mdl_credit <- readRDS(here(mdl_path, "svyglm_probit_credit.rds"))
mdl_mobintpay <- readRDS(here(mdl_path, "svyglm_probit_mobintpay.rds"))
mdl_mmoney <- readRDS(here(mdl_path, "svyglm_probit_mmoney.rds"))
